...
const name = 'andrew';
console.log("Expected output of reverse(name) is werdna  " + myFunctionTest('werdna', reverse(name)));
console.assert(myFunctionTest2('werdna', reverse(name)), 'Expected output of reverse(name) is werdna');
...
console.log("Expected output of findLongestWord(words) is 17  " + myFunctionTest(17, findLongestWord(words)));
console.assert(myFunctionTest(17, findLongestWord(words)), 'Expected output of reverse(name) is werdna');
...
console.log("Expected output of filterLongWords(words) is ['jimkatungukajirom']  " + myFunctionTest( expected, filterLongWords(words,9)));
console.assert(myFunctionTest2( expected, filterLongWords(words)), 'Expected output of filterLongWords(words) is [jimkatungukajirom]');
