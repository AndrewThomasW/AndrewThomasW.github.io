...
let cust = new Customer('andrew');
let cust2 = new cust.constructor('thomas');

console.log(cust2.name); // thomas (worked!)
...
let emp = new Employee('andrew');
let emp2 = new emp.constructor('thomas');
...
describe('describe', function () {
    it("Expected output of me.learn('wap') is John just learned wap", function () {
        assert.equal(me.learn('wap'), 'John just learned wap');
    });
...
prof.initialize("Dr Levi", 65);
console.log(prof.teach("WAP"));

//learn test
describe('teach', function () {
    it("Expected output of prof.teach(WAP) is Dr Levi is now teaching WAP", function () {
        assert.equal(prof.teach("WAP"), 'Dr Levi is now teaching WAP');
    });
